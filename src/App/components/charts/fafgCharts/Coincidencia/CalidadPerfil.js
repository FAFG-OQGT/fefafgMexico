...
export const IdentificadosCalidadPerfil = ({ titulo,data,id="graficaCalidadPerfil",optionsBar,optionsPie }) => {
    const [tipoChart, settipoChart] = useState(true);
    const getData =(canvas) => {
        if(tipoChart){
            return GetDataCoincidencia(types.calidadPerfil, data, types.chartBar,canvas);
        }else{
            return GetDataCoincidencia(types.calidadPerfil, data, types.chartPie,canvas);
        }
    }
