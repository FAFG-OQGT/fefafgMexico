...
function IdentificadoXTipoContexto(props) {
  ...
  const fetchData = async () => {
    const result = await apiFetch("graph/tipoContextoIdent", userf.token);
    setdatag2(result);
  };
      ...
      <Card className={"h-100"}>
        <Card.Header>
          <Row className="align-items-center">
            <Col md={8}>
              <h5 className="d-inline-block mb-0">Identificado por Contexto</h5>
            </Col>
            <Col md={4}>
              <Form.Group className="pull-right">
                <div className="switch d-inline m-r-10">
                  ...
                  />
                  <Form.Label htmlFor="checked-g5" className="cr" />
                </div>
              </Form.Group>
            </Col>
          </Row>
        ...
        <Card.Body>
          <Row className="align-items-center h-100">
            <Col>
              ...
              {!tipoChart && datag2 !== undefined  && <PieChart data={dataPie} options={optionsPie} />}
            </Col>
          </Row>
        </Card.Body>
      </Card>
...
export default IdentificadoXTipoContexto;
