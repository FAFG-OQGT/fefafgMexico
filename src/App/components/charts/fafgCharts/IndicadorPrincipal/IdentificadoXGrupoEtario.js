...
import BarHorizontalChart from "../../allCharts/BarHorizontalChart";
...
function IdentificadoXGrupoEtario(props) {
  ...
  const fetchData = async () => {
    const result = await apiFetch("graph/grupoEtarioIdent", userf.token);
          ...
          <Row className="align-items-center h-100">
            <Col>
              {tipoChart && datag3 !== undefined && (
                <BarHorizontalChart data={dataBar} options={optionsBar} />
              )}{" "}
              {!tipoChart && datag3 !== undefined && (
...
export default IdentificadoXGrupoEtario;
